...
class VO2Calc(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def calc():
            try:
                ...
                if (vo2max > 60):
                    ...
                    tk.Label(right_frame,text = "How are you alive?").grid(row = 6,column = 1,padx = 5,pady = 5)
        ...
        tk.Label(left_frame, text="Type in data in the proper format").grid(row=0, column=0, padx=5, pady=5)
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(left_frame, text="""If you are a new user or looking to put in more data, 
                 click Add More Data to begin""").grid(row = 1, column=0, padx=5, pady=5)
...
class coachadddata(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def new_win():
            ...
            tk.Label(new, text = "Make sure you have your athlete's resting and max heart rates from a downloaded excel sheet").pack(pady=0)
